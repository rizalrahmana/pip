    ...
    <section class="section">
      <div class="d-flex flex-wrap align-items-stretch">
        <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
          <div class="p-4 m-3">
            <img src="<?= base_url() ?>assets/admin/assets/img/578px-Logo_Kota_Malang_color.png" alt="logo" width="80" >
            <h4 class="text-dark font-weight-normal">Welcome to <span class="font-weight-bold">Reswara Apps</span></h4>
            ...
            <div class="text-center mt-5 text-small">
              Copyright &copy; Faris Daroji. Made with 💙 by Stisla
              <div class="mt-2">
          ...
          <div class="absolute-bottom-left index-2">
            <div class="text-light p-5 pb-2">
              <div class="mb-5 pb-3">
                ...
                <h5 class="font-weight-normal text-muted-transparent">Come and login now!</h5>
              </div>
